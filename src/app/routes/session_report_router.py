...
db_path = Config.SESSION_REPORT_DATABASE_PATH
...
@router.get("/api/sessions_report", response_model=SessionsResponse)
def list_sessions():
...
@router.get("/api/sessions_report/{session_id}", response_model=SessionResponse)
def get_session(session_id: str):
    """Get session history and info."""
    try:
...
@router.delete("/api/sessions_report/{session_id}", response_model=DeleteResponse)
...
@router.delete("/api/sessions_report", response_model=DeleteResponse)
