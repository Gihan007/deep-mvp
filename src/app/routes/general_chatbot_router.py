...
@router.post("/api/qa_bot", response_model=ChatQAResponse)
def get_chat_qa(request_data: ChatQARequest, app = Depends(get_app)):
    ...
    try:
        ...
        with get_openai_callback() as cb:
            response = app.general_chatbot.run({
        ...
        answer_text = response.get("answer", None)
        ...
        output_images_data = response.get("output_images_data")
    ...
    try:
        ...
        async def event_gen():
            ...
            try:
                ...
                async for event in app.general_chatbot.stream({
                    "question": request_data.question,
                    "session_id": session_id,
                    "path_images": path_images,
                    "path_files": path_files,
