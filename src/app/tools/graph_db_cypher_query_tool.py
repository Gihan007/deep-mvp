"""
Generic Cypher Query Tool - READ ONLY
"""
...
@tool
def graph_db_cypher_query_tool(query: str) -> str:
    """
    Execute a raw READ-ONLY Cypher query on the graph database.
    """

    logger.info(">>>>>>>>>>>  Executing Generic GraphDB Query Tool")
    logger.info(f"Query: {query}")
    # print(">>>>>>>>>>>  Executing Generic GraphDB Query Tool")
    # print(f"Query: {query}")
    ...
    try:
        ...
        tool_outputs = {
            "tool_name": "graph_db_cypher_query_tool",
