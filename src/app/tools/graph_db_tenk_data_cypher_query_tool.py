"""
10-K Cypher Query Tool - READ ONLY
"""
...
@tool
def graph_db_tenk_data_cypher_query_tool(query: str) -> str:
    """
    Execute a raw READ-ONLY Cypher query for TenKChunk nodes.
    """

    logger.info("Executing 10-K GraphDB Query Tool")
    ...
    try:
        ...
        tool_outputs = {
            "tool_name": "graph_db_tenk_data_cypher_query_tool",
