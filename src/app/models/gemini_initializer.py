...
# Optional dependency: keep import-time safe when Gemini isn't installed.
try:
    ...
    def run_gemini_model(self,
        ...
        if ChatGoogleGenerativeAI is None:
            raise ModuleNotFoundError(
                "langchain_google_genai is not installed. Install 'langchain-google-genai' to use Gemini models."
            )
        safety_settings={
